...
.card.border-low { border-left-color: var(--primary); }
.card.border-medium { border-left-color: var(--warning); }
.card.border-high { border-left-color: var(--danger); }
.card.border-urgent { border-left-color: #c53030; }
