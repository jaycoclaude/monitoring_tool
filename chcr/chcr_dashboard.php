...
<?php
    ...
    elseif($user_access !== '51' &&  $user_access !=='52' && $user_access !=='53' && $user_access !=='100')
    {
...
include 'application_chcr.php';
include 'variations_chcr.php';
include 'renewal_chcr.php';
?>
<head>
      ...
      <div class="roadmap">
        ...
        <details>
          ...
          <ul>
            ...
            <li>
              <a href="chcr_page.php?stage_id=backlog"
                ><i class="fas fa-history"></i> Backlog</a
              >
            </li>
            <li>
              <a href="chcr_page.php?stage_id=10"
                ><i class="fas fa-box"></i> Registered Products</a
              >
            </li>
            <li>
              <a href="chcr_page.php?stage_id=14"
                ><i class="fas fa-times-circle"></i> Rejected</a
              >
            </li>
            <li>
              <a href="chcr_page.php?stage_id=30"
          ...
          <ul>
            <li>
              <details>
                ...
                <ul>
                  <li>
                    <a href="chcr_page.php?stage_id=1"
                      ><i class="fas fa-hourglass-start"></i> Pending
                      Screening</a
                    >
                  </li>
                  <li>
                    <a href="chcr_page.php?stage_id=2"
            ...
            <li>
              <details>
                ...
                <ul>
                  <li>
                    <a href="chcr_page.php?stage_id=8"
                      ><i class="fas fa-envelope"></i> Query Letters to be
                      Sent</a
                    >
                  </li>
                  <li>
                    <a href="chcr_page.php?stage_id=25"
            ...
            <li>
              <details>
                ...
                <ul>
                  <li>
                    <a href="chcr_page.php?stage_id=19"
                      ><i class="fas fa-industry"></i> Pending GMP</a
                    >
                  </li>
                  <li>
                    <a href="chcr_page.php?stage_id=5"
                      ><i class="fas fa-user-check"></i> Pending Peer Review</a
                    >
                  </li>
                  <li>
                    <a href="chcr_page.php?stage_id=6"
    ...
    <div class="grid-container">
        <div id="section1">
                ...
                <div class="group-cards">
                    <div class="group-row">
                        <div class="stat-card-wrapper card-primary">
                            <a href="chcr_page.php?stage_id=all" class="stat-card">
                        ...
                        <div class="stat-card-wrapper card-primary">
                            <a href="chcr_page.php?stage_id=under_process" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-primary">
                            <a href="chcr_page.php?stage_id=backlog" class="stat-card">
                                <div class="stat-content">
                ...
                <div class="group-cards">
                    <div class="group-row">
                        <div class="stat-card-wrapper card-warning">
                            <a href="chcr_page.php?stage_id=1" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-warning">
                            <a href="chcr_page.php?stage_id=2" class="stat-card">
                                <div class="stat-content">
                ...
                <div class="group-cards">
                    <div class="group-row">
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=7" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=3" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=35" class="stat-card">
                                <div class="stat-content">
                    ...
                    <div class="group-row">
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=4" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=36" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=21" class="stat-card">
                                <div class="stat-content">
                    ...
                    <div class="group-row">
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=37" class="stat-card">
                                <div class="stat-content">
                                    <i class="fas fa-folder-plus"></i>
                        ...
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=22" class="stat-card">
                                <div class="stat-content">
                                    <i class="fas fa-file-medical"></i>
                        ...
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=38" class="stat-card">
                                <div class="stat-content">
                ...
                <div class="group-cards">
                    <div class="group-row">
                        <div class="stat-card-wrapper card-secondary">
                            <a href="chcr_page.php?stage_id=8" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-secondary">
                            <a href="chcr_page.php?stage_id=25" class="stat-card">
                                <div class="stat-content">
            ...
            <div class="stage-group peer-review-group">
                <div class="group-header">
                    <h4><i class="fas fa-users"></i> Final Recommendations</h4>
                </div>
                <div class="group-cards">
                    <div class="group-row">
                        <div class="stat-card-wrapper card-warning">
                            <a href="chcr_page.php?stage_id=19" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-warning">
                            <a href="chcr_page.php?stage_id=5" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-warning">
                            <a href="chcr_page.php?stage_id=6" class="stat-card">
                                <div class="stat-content">
            ...
            <div class="stage-group outcome-group">
                ...
                <div class="group-cards">
                    <div class="group-row">
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=10" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=14" class="stat-card">
                                <div class="stat-content">
                        ...
                        <div class="stat-card-wrapper card-success">
                            <a href="chcr_page.php?stage_id=30" class="stat-card">
                                <div class="stat-content">
            ...
            <div class="stage-group renewal-group">
                ...
                <div class="group-cards">
                    <div class="group-row">
                        ...
                        <div class="stat-card-wrapper card-info">
                            <a href="chcr_page.php?stage_id=renewal" class="stat-card">
                                <div class="stat-content">
        ...
        <div id="section3" style="display: none;">
            <div class="stage-group variation-group">
                ...
                <div class="group-cards">
                    <div class="group-row">
                        <div class="stat-card-wrapper card-primary">
                            <a href="chcr_page.php?stage_id=variation" class="stat-card">
                                <div class="stat-content">
                                    <i class="fas fa-list-check"></i>
  ...
  <script>
    ...
    const doughnutCharts = [
      ...
      },
      {
        ...
        data: [<?php echo $percentage_ontime_stage1;?>, <?php echo $percentage_delayed_stage1;?>, <?php echo $percentage_tobedelayed_stage1;?>],
        labels: ["On Time", "Delayed", "ToBeDelayed"],
        colors: dimColors,
      },
      {
        id: "chart-under-screening",
        data: [<?php echo $percentage_ontime_stage1;?>, <?php echo $percentage_tobedelayed_stage2;?>, <?php echo $percentage_delayed_stage2;?>],
        labels: ["On Time", "Delayed", "ToBeDelayed"],
        colors: dimColors,
      },
      {
        id: "chart-pending-assessment",
        data: [<?php echo $percentage_ontime_stage7;?>, <?php echo $percentage_tobedelayed_stage7;?>, <?php echo $percentage_delayed_stage7;?>],
        labels: ["On Time", "Delayed", "ToBeDelayed"],
        colors: dimColors,
      },
      {
      ...
      },
      {
        ...
        data: [<?php echo $percentage_ontime_stage35;?>, <?php echo $percentage_tobedelayed_stage35;?>, <?php echo $percentage_delayed_stage35;?>],
        labels: ["On Time", "Delayed", "ToBeDelayed"],
        colors: dimColors,
      },
      {
