...
$sql = "SELECT 
        ...
        FROM tbl_ins_applications_premise_food ha
        LEFT JOIN tbl_hm_applications_status_food_ins st ON ha.application_current_stage = st.status_id
        WHERE ha.application_id = :app_id";
...
$stagesQuery = "SELECT status_id, status_description 
                FROM tbl_hm_applications_status_food_ins 
                WHERE status = 1 
...
$stageFlowQuery = "SELECT sf.from_stage_id, sf.to_stage_id, sf.sequence_order,
                   ...
                   FROM tbl_stage_flow_food_ins sf
                   LEFT JOIN tbl_hm_applications_status_food_ins from_stage ON sf.from_stage_id = from_stage.status_id
                   LEFT JOIN tbl_hm_applications_status_food_ins to_stage ON sf.to_stage_id = to_stage.status_id
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['move_stage'])) {
    try {
        ...
        $updateAppQuery = "UPDATE tbl_ins_applications_premise_food 
...
<div class="container mt-4 mb-5">
  ...
  <div class="app-info-card">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="info-badge">
          <strong>Applicant Name:</strong> <?php echo htmlspecialchars($app_data['applicant_name']); ?>
        </div>
        <div class="info-badge">
