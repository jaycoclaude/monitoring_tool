...
try {
    ...
    error_log('Error in hmdr_page: ' . $e->getMessage());
...
$base_query = "FROM tbl_hm_applications";
$params = [];
$stage_name = '';
...
if ($stage_id === 'all') {
    ...
    $base_query .= " WHERE DATEDIFF(CURDATE(), date_submitted) > 365";
                ...
                <div id="myDiv" style="width:100%; overflow: auto;">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr>
                                <td colspan="11"><p><a href="../landing_page.php">Back to HomePage</a></p></td>
                            </tr>
                            <tr>
                                <td><b>No.</b></td>
                            ...
                            <tbody id="myTable">
                                ...
                                foreach ($applications_req as $application_req) {
                                    ...
                                    // Output table row
                                    echo "<tr class='clickable-row' data-href='hmdr_more_details.php?app_id=$hm_application_id'>
                                        <td>" . ++$i . "</td>
                                        <td>$reference_no</td>
                                        <td>$brand_name</td>
                    ...
                    <div class="pagination-container">
                        ...
                        <div class="form-inline">
                            ...
                            <select class="form-control" onchange="window.location.href='<?php echo "hmdr_page.php?" . http_build_query(array_filter(['stage_id' => $stage_id, 'by' => $_GET['by'] ?? null, 'page' => 1, 'limit' => '', 'search' => $search], 'strlen')); ?>&limit=' + this.value">
                                <?php
